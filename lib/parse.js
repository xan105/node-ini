...
function parse (string, option = {}){
  ...
  const options = {
    ...
    comment: asBoolean(option.comment) ?? false,
  ...
  const save = function(){
      if (section && !ignoreSection){
        Object.defineProperty(comments[section], Symbol("root"), {
        ...
        Object.defineProperty(comments, Symbol("root"), {
          enumerable: true, //don't "hide" it
          configurable: false,
          writable: true,
          value: Array.from(comment)
  ...
  if (options.comment){
    Object.defineProperty(result, Symbol("comment"), {
      enumerable: false,
      configurable: false,
      writable: false,
      value: comments
